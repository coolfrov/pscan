...
namespace chainer
{
    ...
    private:
        ...
        void filter_pointer_to_fmmap(char *buffer, T start, size_t len, vm_area_data *vma, FILE *&f);

        // void filter_pointer_to_fmmap_by_page(char *buffer, T start, size_t len, vm_area_data *vma, FILE *&f);
